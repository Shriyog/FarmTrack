package com.example.farmtrack.cal;
...
//	        if(d.getYear() == cal.get(Calendar.YEAR) && d.getMonth() == cal.get(Calendar.MONTH))
			...
			if(i>3)
			{
		        v = vi.inflate(R.layout.red, null);
				today = (FrameLayout)v.findViewById(R.id.today_frame);				
				today.setVisibility(View.VISIBLE);
				i=0;
			}
			if((i==2||i==3))
			{
		        v = vi.inflate(R.layout.orange, null);
				today = (FrameLayout)v.findViewById(R.id.today_frame);				
				today.setVisibility(View.VISIBLE);
			}
			if(i==1)
			{
		        v = vi.inflate(R.layout.yellow, null);
				today = (FrameLayout)v.findViewById(R.id.today_frame);				
				today.setVisibility(View.VISIBLE);
			}
	        }
